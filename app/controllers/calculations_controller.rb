class CalculationsController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to calculations_path, status: :see_other, notice: "Calculation was successfully destroyed." }
  ...
  private
    ...
    def calculation_params
      params.require(:calculation).permit(:num1, :opt, :num2)
    end
end
